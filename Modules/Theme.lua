local Theme = {
	...
	PrimaryTextColor = Color3.fromRGB(230, 230, 230),  -- Brighter white for primary text
	SecondaryTextColor = Color3.fromRGB(160, 180, 200),  -- Lighter muted grey-blue for secondary text
